...
from local_ai_bridge.ui.project_notes import build_project_notes_tab
...
def build_central_ui(window) -> QSplitter:
    ...
    window.project_notes_tab = build_project_notes_tab(window)
    ...
    window.tabs.addTab(window.project_notes_tab, _('Note e attività'))
